...
应客户要求，基于hibernate7.4.1进行适配（支持 A 兼容（Oracle 风格）、M 兼容（MySQL 风格）），数据库版本505.2.1 0800SPC
...
Please use GitHub Issues: https://github.com/huaweicloud-samples/hibernate-orm7.4.1/issues
